    ...
    <div id="home">
        ...
        <div v-if="!this.$parent.authenticated">
            ...
            <p>
                ...
                <a href="https://developer.okta.com/docs/guides/implement-auth-code-pkce">PKCE Flow</a> to your application.
            </p>
            <p>
                When you click the login button below, you will be redirected to the login page on your Okta org. After you authenticate,
        ...
        <div v-if="this.$parent.authenticated">
            ...
            <ul>
                <li v-for="(example, index) in resourceServerExamples"
                    :key="index">
